...
class TPCBatchDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        reg_features = torch.from_numpy(np.copy(self.memmap_reg_target[real_idx])).unsqueeze(0)
        ...
        norm_reg_features = reg_features[:, ind.squeeze()]
        ...
        serialized_reg_features = norm_reg_features[:, sorter.squeeze()].squeeze(0)
        
        return serialized_points * self.data_scaler, serialized_target, knearest_points * self.data_scaler, serialized_reg_features
...
class MyCollator(object):
    ...
    def __call__(self, batch):
        ...
        for g, t, k, r in batch:
            ...
            reg.append(torch.nn.functional.pad(r, (0, 0, 0, point_longest - g.size(0)), value = pad_val))
        ...
        return (grouped, targets, knearest, reg)
